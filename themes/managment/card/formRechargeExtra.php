<div class="flex items-center mx-auto max-w-[960px] h-full" data-menu="cartao">
    ...
    <?= csrf_input(); ?>
        <div class="flex flex-col gap-2">
            <h1 class="text-xl font-semibold text-white">Solicitação de Recarga Extra</h1>
            ...
            <div class="flex flex-col md:flex-row w-full gap-4">
                <div class="flex flex-col w-full">
                    ...
                    <div class="flex items-center">
                        <input type="text" class="w-[300px] bg-gray-700 text-white p-2 rounded-xs">
                        <button class="cursor-pointer bg-gray-700 p-2 rounded-r-full cursor-pointer text-white">
