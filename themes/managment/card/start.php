...
<div class="md:p-4 md:h-screen">
    <div class="flex flex-col h-full overflow-hidden w-screen md:w-auto rounded-md">
        ...
        <header class="w-screen md:w-auto md:flex md:justify-start flex flex-col pt-4 px-3 gap-3 border-b border-gray-700">
            <div class="flex">
                <a href="<?= url("/cartao/novocartao");?>" class="novo text-center justify-center main-card-menu py-1 px-4 cursor-pointer font-semibold duration-all transition-300 w-full md:w-auto text-gray-400 text-white border-b-2 border-green-500">Novo</a>
        ...
        <?php if($menu === "novocartao"): ?>
            <header class="w-screen md:w-auto md:flex md:justify-start mt-6 md:mt-0 py-4 flex flex-col gap-3 flex flex-col gap-3">
                <h1 class="uppercase text-light text-white">Filtros específicos</h1>
                <div class="flex flex-col md:flex-row">
                    <a href="<?= url("/cartao/solicitado");?>" class="solicitado py-1 px-4 cursor-pointer font-semibold duration-all transition-300 w-full md:w-auto text-gray-600 solicitado text-white">Solicitados</a>
                    <a href="<?= url("/cartao/enviado");?>" class="second-card-menu enviado py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto">Enviados</a>
                    <a href="<?= url("/cartao/cartaoativo"); ?>" class="second-card-menu cartao py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto">Cartões</a>
                </div>
            </header>
        ...
        <?php elseif ($menu === "solicitacao"): ?>
            <header class="w-screen md:w-auto md:flex md:justify-start mt-6 md:mt-0 py-3 px-6 flex flex-col ">
                <h1 class="text-white text-xl">Pesquisar</h1>
                    <div class="flex items-center gap-3">
                        <div class="flex items-center w-full">
                            <input name="recipientname" id="recipientname" type="text" class="input-search w-full pr-6 py-2 px-3 border border-gray-400 rounded-l-md text-white" placeholder="Pesquisar Beneficiários...">
                            <button data-url="<?= url("/cartao/procurarsolicitacao") ?>" id="search-all" class="py-2 px-4 cursor-pointer border border-gray-400 bg-gray-100 rounded-r-md">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                                </svg>
                ...
                <div class="flex flex-col md:flex-row">
                    <a href="<?= url("/cartao/solicitado");?>" class="main-card-menu novo py-1 px-4 text-sm cursor-pointer font-semibold duration-all transition-300 w-full md:w-auto text-white solicitado">Solicitados</a>
                    <a href="<?= url("/cartao/enviado");?>" class="second-card-menu enviado py-1 px-4 cursor-pointer text-white font-semibold duration-all transition-300 w-full md:w-auto text-sm">Enviados</a>
                    <a href="<?= url("/cartao/cartaoativo"); ?>" class="second-card-menu cartao py-1 px-4 cursor-pointer text-white font-semibold duration-all transition-300 w-full md:w-auto text-sm">Cartões</a>
                </div>
            </header>
