...
<div class="md:p-4 bg-gray-100 md:h-screen">
    <div class="flex flex-col h-full overflow-hidden w-screen md:w-auto rounded-md bg-white">
        <div class="sidebar" data-menu="cartao"></div>
        <header class="pt-10 md:pt-4 px-4 flex justify-start">
        ...
        <header class="w-screen md:w-auto md:flex md:justify-start flex flex-col pt-4 px-3 gap-3 border-b border-gray-200">
            <div class="flex">
                <a href="<?= url("/cartao/novocartao");?>" class="novo text-center justify-center main-card-menu py-1 px-4 cursor-pointer font-semibold duration-all transition-300 w-full md:w-auto text-gray-400 text-gray-800 border-b-4 border-gray-900">Novo</a>
                <a href="<?= url("/cartao/solicitaremergencial");?>" class="emergencial text-center justify-center main-card-menu py-1 px-4 cursor-pointer text-gray-400 font-semibold duration-all transition-300 w-full md:w-auto">Emergencial</a>
                <a href="<?= url("/cartao/recarga");?>" class="recarga text-center justify-center main-card-menu py-1 px-4 cursor-pointer text-gray-400 font-semibold duration-all transition-300 w-full md:w-auto">Recarga</a>
                <a href="<?= url("/cartao/beneficiario");?>" class="beneficiario text-center justify-center main-card-menu py-1 px-4 cursor-pointer text-gray-400 font-semibold duration-all transition-300 w-full md:w-auto">Beneficiário</a>
                <a href="<?= url("/cartao/atualizarsaldo");?>" class="saldo text-center justify-center main-card-menu py-1 px-4 cursor-pointer text-gray-400 font-semibold duration-all transition-300 w-full md:w-auto">Atualizar Saldos</a>
            </div>
        </header>
        ...
        <?php elseif($menu === "segundavia"): ?>
            <header class="w-screen md:w-auto md:flex md:justify-start mt-6 md:mt-0 py-3 px-6 flex flex-col gap-3">
                <h1 class="uppercase text-light text-gray-500">Filtros específicos</h1>
                <div class="flex flex-col md:flex-row">
                    <a href="<?= url("/cartao/solicitado");?>" class="solicitado py-1 px-4 cursor-pointer font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full text-gray-600 solicitado text-white">Solicitados</a>
                    <a href="<?= url("/cartao/enviado");?>" class="second-card-menu enviado py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Enviados</a>
                    <a href="<?= url("/cartao/cartaoativo"); ?>" class="second-card-menu cartao py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Cartões</a>
                </div>
            </header>
        <?php elseif ($menu === "novo"): ?>
            <header class="w-screen md:w-auto md:flex md:justify-start mt-6 md:mt-0 py-3 px-6 flex flex-col gap-3">
                ...
                <div class="flex flex-col md:flex-row">
                    <a href="<?= url("/cartao/solicitado");?>" class="main-card-menu novo py-1 px-4 text-sm cursor-pointer font-semibold duration-all transition-300 w-full md:w-auto rounded-full bg-green-700 text-black text-gray-600 solicitado text-white">Solicitados</a>
                    <a href="<?= url("/cartao/enviado");?>" class="second-card-menu enviado py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Enviados</a>
                    <a href="<?= url("/cartao/cartaoativo"); ?>" class="second-card-menu cartao py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Cartões</a>
                </div>
            </header>
        <?php elseif ($menu === "solicitacao"): ?>
            <header class="w-screen md:w-auto md:flex md:justify-start mt-6 md:mt-0 py-3 px-6 flex flex-col gap-3">
                ...
                <div class="flex flex-col md:flex-row">
                    <a href="<?= url("/cartao/solicitado");?>" class="main-card-menu novo py-1 px-4 text-sm cursor-pointer font-semibold duration-all transition-300 w-full md:w-auto rounded-full bg-green-700 text-gray-600 solicitado">Solicitados</a>
                    <a href="<?= url("/cartao/enviado");?>" class="second-card-menu enviado py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Enviados</a>
                    <a href="<?= url("/cartao/cartaoativo"); ?>" class="second-card-menu cartao py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Cartões</a>
                </div>
            </header>
        ...
        <?php elseif ($menu === "enviado"): ?>
            <header class="w-screen md:w-auto md:flex md:justify-start mt-6 md:mt-0 py-3 px-6 flex flex-col gap-3">
                ...
                <div class="flex flex-col md:flex-row">
                    <a href="<?= url("/cartao/solicitado");?>" class="second-card-menu solicitado py-1 px-4 cursor-pointer  font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full text-gray-600 solicitado">Solicitados</a>
                    <a href="<?= url("/cartao/enviado");?>" class="second-card-menu enviado py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Enviados</a>
                    <a href="<?= url("/cartao/cartaoativo"); ?>" class="cartaoativo second-card-menu cartao py-1 px-4 cursor-pointer text-gray-600 font-semibold duration-all transition-300 w-full md:w-auto text-sm rounded-full">Cartões</a>
                </div>
            </header>
                ...
                <div class="p-6 px-0 hidden md:block">
                    <div class="content-ajax h-full ">
                        ...
                        <?php elseif ($menu === "solicitacao"): ?>
                            ...
                            <div class="py-4 items-center flex justify-end">
                                <div class="flex items-center gap-2">
                                    <a href="<?= url("/cartao/solicitarsegundaviacartao") ?>" class="flex gap-1 items-center py-2 px-3 border border-gray-400 cursor-pointer text-gray-800 rounded-full hover:bg-green-800 hover:text-white transition-all duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m.75 12 3 3m0 0 3-3m-3 3v-6m-1.5-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                                        </svg>
                                        <span>2° Via</span>
...
<script>
    ...
    if (vUrlPage === 'novocartao') {
       ...
       solicitado[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800'); 
        ...
        benefit[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800');
        novo[0].classList.remove('border-b-4', 'border-gray-900', 'text-gray-800');
    }
        ...
        balance[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800');
        novo[0].classList.remove('border-b-4', 'border-gray-900', 'text-gray-800');
    }
      else if (vUrlPage === 'recargaextra') {
        recarga_extra[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800');
    }
    // bottom options
        ...
        enviado[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800');
        novo[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800');
    }
      else if (vUrlPage === 'cartaoativo') {
        cartaoativo[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800'); 
        novo[0].classList.add('border-b-4', 'border-gray-900', 'text-gray-800');
    }
      else if (vUrlPage === 'solicitado') {
