...
<body class="font-[Arial] p-0 bg-black/80">
    ...
    <div class="flex flex-col gap-4 w-full">
        <div id="conteudo1" class="pagina-pdf conteudo pl-12 pr-6 pt-4 pb-4 flex flex-col justify-between gap-5">
            ...
            <!-- Título do Ofício -->
            <h1 class="text-lg font-bold uppercase mb-2 print:mb-4">Ofício Nº: <?=  format_number($dataDocumentItem["numberOffice"] ?? 000); ?> – Gabinete – Semdes</h1>
            ...
            <div class="mb-4">
                ...
                <p class="font-bold"><?= $dataDocumentItem["unit"] ??  null; ?></p>
            </div>
            <!-- Assunto -->
            <p class="font-bold mb-4">Encaminhamento do Cartão Social.</p>
            <!-- Saudação e Corpo -->
            <p class="font-bold">Prezado,</p>
            <div class="text-justify indent-12">Ao cumprimenta-la, venho por meio deste encaminhar <?= format_number($dataDocumentItem["countCard"] ?? 00); ?> cartões nominais desta unidade.</div>
        ...
        <div id="conteudo2" class="pagina-pdf conteudo pl-12 pr-6 pt-4 pb-4 flex flex-col justify-between gap-5">
                <!-- Cabeçalho com logos (substitua src pelas URLs reais dos brasões) -->
                <div class="flex justify-between items-center gap-12 h-full">
                    <div class="flex flex-col">
                        <img src="<?= theme("/img/brazao.png", CONF_VIEW_APP); ?>" alt="Brasão Estado do Pará" class="w-[60px]">
        ...
        <div id="conteudo3" class="pagina-pdf conteudo pl-12 pr-6 pt-4 pb-4 flex flex-col justify-between gap-5">
                <!-- Cabeçalho com logos (substitua src pelas URLs reais dos brasões) -->
                <div class="flex justify-between items-center gap-12 h-full">
                    <div class="flex flex-col">
                        <img src="<?= theme("/img/brazao.png", CONF_VIEW_APP); ?>" alt="Brasão Estado do Pará" class="w-[60px]">
